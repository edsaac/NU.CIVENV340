...
def main():
    ...
    ****
    ...
    tabs = st.tabs(["🌊 Normal operation", "💸 Upgrade", "🏄‍♀️ Main spillway fail", "🪨 Emergency spillway", "🛠️ Repairs", "🚧 Risks"])
    urls = [
    ...
    ****
    ...
    with cols[1]:
        ...
        with lilcols[0]: st.metric("Total Dams", "> 90,000")
        with lilcols[1]: st.metric("Avg. age", "61 years")
        with lilcols[2]: st.metric("with Hydropower", "3%")
